...
def afria():
    ...
    if choice == "yes":
        if gold < 0.50:
            ...
            print("It seems the pavilion is out of budget.")
            print("Let's go to THE UNISPHERE.")
            time.sleep(3)            
            unisphere()
    elif choice == "no":
...
def amera():
    ...
    if choice == "yes":
        if gold < 0.25:
            ...
            print("It seems the pavilion is out of budget.")
            print("Let's go to THE MISSOURI Pavilion.")
            time.sleep(3)
            missouri_pav()
    elif choice == "no":
...
def bela():
    ...
    if choice == "yes":
        if gold < 0.60:
            ...
            print("It seems the pavilion is out of budget.")
            print("Let's go to THE VATICAN PAVILION.")
            time.sleep(3)
            vatican_pav()
    elif choice == "no":
...
def ckia():    
    ...
    if choice == "yes":
        if gold < 1:
            ...
            print("It seems the meal is out of budget.")
            cki1()
    elif choice == "no":
...
def int1():    
    ...
    if choice == "yes":
        if gold < 1:
            ...
            print("You have ",gold)
            print("It seems the pastry is out of budget.")
            inta()
    elif choice == "no":
        print("Of course, as you please.")
        inta()
...
def loua():
    ...
    if choice == "yes":
        if gold < 1:
            ...
            print("It seems the Teen-Age Center is out of budget.")
            loub()
    elif choice == "no":
...
def pepa():
    ...
    if choice == "yes":
        if gold < 0.60:
            ...
            print("It seems the pavilion is out of budget.")
            print("Let's go to THE EASTMAN KODAK PAVILION.")
            time.sleep(3)
            eastman_pav()
    elif choice == "no":
...
def seia():
    ...
    if choice == "yes":
        if gold < 0.10:
            ...
            print("It seems the pavilion is out of budget.")
            print("Let's go to THE MALAYSIA PAVILION.")
            time.sleep(3)
            malaysia_pav()  
    elif choice == "no":
...
def usra():
    ...
    if choice == "yes":
        if gold < 0.25:
            ...
            print("It seems the pavilion is out of budget.")
            print("Let's go to THE CHRYSLER PAVILION.")
            time.sleep(3)
            chrysler_pav
    elif choice == "no":
...
def walta():
    ...
    if choice == "yes":
        if gold < 0.50:
            ...
            print("It seems the museum is out of budget.")
            waltb()
    elif choice == "no":
        print("Of course, let's move on.")
        waltb()
