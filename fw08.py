...
def halla():
    ...
    if choice in positive:
        ...
        time.sleep(2)
        print("You hear a couple beeks and some clicking noises\nand the machine prints out a slip of paper that reads\n")
...
def nysc_pav():
#    time = 30     
    print("As you walk around the Theaterama you enjoy the artwork on the outside of the theatre\nby Pop artists such as John Chamberlain, Robert Indiana, Roy Lichtenstein, Robert Rauschenberg and James Rosenquist.")
    nysca()
def nysca():
...
def seia():
    ...
    if choice in positive:
        ...
        time.sleep(5)
        print("YOU ARE AT THE MALAYSIA PAVILION")
        malaysia_pav()
    else:
        print("I didn't understand that.\n")
        seia()
...
def areas():    
    ...
    if choice in positive:
        ...
        print("The Industrial Area has 45 pavilions\nthat showcases America's industry.\nThe International Area is represented\nby 80 nations in 37 pavilions.")
        print("The Federal and State Area represents 19 states.\nThe Transportation Area shows off\nthe many forms of transportation.")
        print("The Lake Amusement Area is the smallest section,\nbut with the most variety.\nThe Flushing Bay Area is a place\nfor seafarers and sports fans.\n")            
        first() 
    elif choice in negative:    
        print("Of course, as you please.\n") 
        first()  
...
# No time
def incurable():
    print("It looks like you are out of time.\nYou say out loud 'Oh boy, I better get home before dinner!'\nI hope you enjoyed your day at the 1964-1965 World's Fair!")
    exit()
