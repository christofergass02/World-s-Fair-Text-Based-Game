...
#    time = 45
    ...
    print("You scrounge around your pockets to see if you have a couple quarters.")
    print ("Current cash = ",gold)
    afria()
def afria():
...
#    time = 25
    ...
    print("You scrounge around your pockets to see\nif you have a quarter or some other loose change.")
    print ("Current cash = ",gold)
    amera()
def amera():
    choice = input("Do you pay to enter the pavilion?\nyes or no?\n ")
...
#    time = 60
    ...
    print("You scrounge around your pockets to see if you have a couple quarters and a dime.")
    print ("Current cash = ",gold)
    bela()
def bela():
    choice = input("Do you pay to enter the pavilion?\nyes or no?\n ")
...
#    time = 
    ...
    print("You scrounge around your pockets to see if you the dollar needed for the delicious looking pastry.")
    print("Current cash = ",gold)
    ckia()
def ckia():    
...
#    time = 
    ...
    print("You scrounge around your pockets to see if you have a dollar.")
    print("Current cash = ",gold)
    cca()
def cca():    
    choice = input("Do you decide to enter one dollar?\nyes or no\n ")
    if choice == "yes":
        gold = gold-1
        print("Current cash = ",gold)
...
def leb1():    
    ...
    if choice == "left":
        ...
        print("\nYOU ARE AT THE PHILIPPINES PAVILION.")
        phil_pav()
    else:
        print("I didn't understand that.\n")
        leb1()
...
def louisiana_pav():    
#    money = 1.00 (for teen-age center)
#    time = 30    
    ...
    print("You scrounge around your pockets to see if you have enough money.")
    print ("Current cash = ",gold)
    loua()
def loua():
    choice = input("Do you pay to enter the pavilion?\nyes or no?\n ")
    ...
    loub()
def loub():
    print("After taking the rest of the pavilion you consider the next place to go.")
...
#    time = 10
    ...
    if choice == "yes":
        ...
        if randint == 1: 
            ...
            print("\nYou ask a black woman who the man in the middle of the crowd is\nand she says that he is Robert Moses, president of the fair\nand one of the most dispicable human beings alive due to the mistreatment\nof minority groups while he was in charge of public housing in New York throughout the 1950s.\n")
            print("After you learn a little about the fair's president you decide where to go next.")
            fairs1() 
    elif choice == "no":
...
#    time = 30 
    ...
    print("You scrounge around your pockets to see if you have a dime or two nickels.")
    print("Current cash = ",gold)
    seia()
def seia():
    choice = input("Do you pay to enter the pavilion?\nleft or right?\n ")
...
#    time = 10 
    ...
    print("You scrounge around your pockets to see if you have a quarter.")
    print("Current cash = ",gold)
    usra()
def usra():
...
def usrb():
    print("Wow you were able to see all the Transportation section,\nas well as most Fair, in addition to the city skyline.")
...
#    time = 
def walters_pav():
    print("As you come up to the entrance of the restaurant\nyou are asked to pay 50 cents.")
    print("You scrounge around your pockets to see if you have two quarters.")
    print("Current cash = ",gold)
    walta()
def walta():
    choice = input("Do you pay to take the ride?\nleft or right?\n ")
